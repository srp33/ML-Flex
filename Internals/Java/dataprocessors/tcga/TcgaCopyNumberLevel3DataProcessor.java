...
/** This data processor parses chromosome-level data for Illumina SNP arrays for data from The Cancer Genome Atlas. This data can be downloaded from The TCGA data can be downloaded from http://tcga-data.nci.nih.gov/tcga/dataAccessMatrix.htm.
 * @author Stephen Piccolo
 */
public class TcgaCopyNumberLevel3DataProcessor extends AbstractTcgaDataProcessor
{
    private final static String INPUT_FILE = "hudsonalpha.org__HumanHap550__snp_analysis.seg.txt";
