...
public class ClassificationResultsSaver
{
    ...
    /** Saves classification result values for either inner or outer cross-validation folds. This should only get called for inner folds if we are performing a training/Action experiment.
     *
