...
\    * @return Number of inner cross-validation folds
    ...
    /** Gets the configuration value indicating any data instances that should be used specifically for Action. If this is not specified, they will be assigned randomly. It is also possible to specify a path to a text file containing a list of data instance IDs (one on each line).
     *
     * @return Data instance IDs
     * @throws Exception
     */
