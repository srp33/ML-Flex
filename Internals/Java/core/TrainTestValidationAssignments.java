...
/** This class stores assignments of data instances to either training or Action groups. It is used when cross-validation is NOT performed (or you can think of it as one-fold cross-validation).
...
public class TrainTestValidationAssignments extends CrossValidationAssignments
{
    ...
    {
        if (fold > 1)
            throw new Exception("When performing training and Action, only fold 0 is allowed. Fold " + fold + " was specified.");
